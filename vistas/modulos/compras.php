                                ...
                                <table class="table table-striped table-bordered tablas text-center">
                                    ...
                                    <?php
                                        ...
                                        echo '
                                                ...
                                                <td>
                                                <button class="btn btn-warning btnEditarInventario" idInventario="'.$value["id_inventario"].'" data-toggle="modal" data-target="#modalEditarProducto"><i class="fas fa-pencil-alt" style="color:#fff"></i>
                                                AGREGAR COMPRA
                                                </button>
