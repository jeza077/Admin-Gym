  ...
  <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <button class="btn btn-danger btnExportarRespaldo float-right mr-3 ">
              Exportar PDF          
            </button>
          </div>
        </div>
      ...
      <div class=" col-sm-12">
        ...
        <ul class="nav nav-tabs" id="myTab" role="tablist">
          ...
          <li class="nav-item" role="presentation">
            ...
            <?php
              $descripcionEvento = " Consulto la pantalla de Restauración";
              $accion = "consulta";
            ...
            <div class="tab-content" id="myTabContent">
              ...
              <div class="tab-pane fade" id="second" role="tabpanel" aria-labelledby="Inscripciones  y   Matricula">
                ...
                <div class="form-group ">
                  ...
                  <div class="input-group col-md-12">   
                    <span class="input-group-text"><i class="fas fa-database"></i></span>
                    <select class="form-control select2 input-lg" name="restorePoint" id="restorePoint" style="width:90%" required>
