        ...
        <div class="modal-body">
           ...
           <div class="card-body">
              ...
              <div class= "form-group col-md-12">
               ...
               <input type="text" class="form-control longitudDireccion" id="editarValorParametro" name="editarValorParametro" placeholder="Escriba el nuevo valor del parametro"requiered>
              </div>
