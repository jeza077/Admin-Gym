          ...
          <form role="form" method="post" class="formulario" enctype="multipart/form-data">
            ...
            <div class="form-row">
              ...
              <div class="form-group col-md-4">
                ...
                <input type="number" class="form-control sinLetras sinCaracteres" id="nuevoProductoMinimo" name="nuevoProductoMinimo" placeholder="Cantidad mín." min="0" required class="fa fa-arrow-up"></i></span>
              </div>
              <div class="form-group col-md-4">
                <label for="productomaximo">Producto máximo</label>
                <input type="number" class="form-control sinLetras sinCaracteres" id="nuevoProductoMaximo" name="nuevoProductoMaximo" placeholder="Cantidad máx." min="0" required class="fa fa-arrow-up"></i></span>
              </div>
            </div>
