...
class ModeloUsuarios{
	...
	static public function mdlEditarUsuario($tabla, $datos){
		...
		$stmt = Conexion::conectar()->prepare("UPDATE $tabla SET usuario = :usuario, foto = :foto, password = :password, fecha_vencimiento = :fecha_vencimiento, id_rol = :id_rol WHERE id_persona = :id_persona");
