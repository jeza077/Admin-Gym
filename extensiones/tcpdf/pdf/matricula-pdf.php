...
$descripcionEvento = "".$_SESSION['usuario']." Generó reporte pdf de matrícula";
$accion = "Generar";
$bitacoraConsulta = ControladorMantenimientos::ctrBitacoraInsertar($_SESSION['id_usuario'], 22, $accion,
$descripcionEvento);
...
class PDF extends TCPDF{
    ...
    public function Header() {
        ...
        $this->Cell(180, 3, 'REPORTE DE MATRÍCULAS', 0, 1, 'C');
        $this->Ln(3);
...
$pdf->Cell(70, 5, 'Tipo de Matrícula', 1, 0, 'C', 1);
...
$matricula = ControladorGlobales::ctrRangoMatricula($rango);
//var_dump($matricula);
