...
$descripcionEvento = "".$_SESSION['usuario']." Generó reporte pdf de inventario";
$accion = "Generar";
$bitacoraConsulta = ControladorMantenimientos::ctrBitacoraInsertar($_SESSION['id_usuario'], 10, $accion,
$descripcionEvento);
