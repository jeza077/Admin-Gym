...
$pdf->Cell(75, 5, 'Objeto', 1, 0, 'C', 1);
$pdf->Cell(55, 5, 'Link', 1, 0, 'C', 1);
$pdf->Cell(40, 5, 'Icono', 1, 0, 'C', 1);
...
$proveedor = ControladorGlobales::ctrRangoObjetos($rango);
//var_dump($proveedor);
...
if(!$proveedor){  
    ...
    $i = 1; //Contador
    $max = 23; //Maximo de registros a mostrar en una pagina
...
foreach ($proveedor as $key => $value) {
    ...
    $pdf->Cell(75, 4, ''.$value['objeto'].' ', 0, 0, 'C');
    $pdf->Cell(55, 4, ''.$value['link_objeto'].' ', 0, 0, 'C');
    $pdf->Cell(40, 4, ''.$value['icono'].' ', 0, 0, 'C');  
