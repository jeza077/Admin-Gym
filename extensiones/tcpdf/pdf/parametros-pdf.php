...
$descripcionEvento = "".$_SESSION['usuario']." Generó reporte pdf de parámetros";
$accion = "Generar";
$bitacoraConsulta = ControladorMantenimientos::ctrBitacoraInsertar($_SESSION['id_usuario'], 20, $accion,
$descripcionEvento);
...
class PDF extends TCPDF{
    ...
    public function Header() {
        ...
        $this->Cell(180, 3, 'REPORTE DE PÁRAMETROS', 0, 1, 'C');
        $this->Ln(3);
...
$pdf->MultiCell(100, 5, 'Parámetros', 1, 'C', 0, 0, '', '', true);
...
$parametross = ControladorGlobales::ctrRangoParametro($rango);
//var_dump($parametross);
