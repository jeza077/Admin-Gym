...
$descripcionEvento = "".$_SESSION['usuario']." Generó reporte pdf de documentos";
$accion = "Generar";
$bitacoraConsulta = ControladorMantenimientos::ctrBitacoraInsertar($_SESSION['id_usuario'], 24, $accion,
$descripcionEvento);
...
class PDF extends TCPDF{
    ...
    public function Header() {
        ...
        $this->Cell(180, 3, 'REPORTE DE DOCUMENTOS', 0, 1, 'C');
        $this->Ln(3);
...
$pdf->Cell(80, 5, 'Tipo de documento', 1, 0, 'C', 1);
...
$documento = ControladorGlobales::ctrRangoDocumento($rango);
//var_dump($documento);
...
foreach ($documento as $key => $value) {
    ...
    $pdf->Cell(80, 4, ''.$value['tipo_documento'].' ', 0, 0, 'C');
    if($value["estado"] == 0){
        $pdf->Cell(100, 4, 'Desactivado', 0, 0, 'C');
    } else {
...
$pdf->Output('reporte_documentos.pdf', 'I');
