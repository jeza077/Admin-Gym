...
class PDF extends TCPDF{
    ...
    public function Header() {
        ...
        $this->Cell(180, 3, 'REPORTE DE RESPALDOS', 0, 1, 'C');
        $this->Ln(3);
...
$pdf->SetTitle('Reporte de Respaldo');
$pdf->SetSubject('');
$pdf->SetKeywords('');
...
$pdf->Cell(50, 5, 'Nombre backup', 1, 0, 'C', 1);
$pdf->Cell(60, 5, 'Fecha de creación', 1, 0, 'C', 1);
$pdf->Cell(60, 5, 'Creado por', 1, 0, 'C', 1);
...
$backup = ControladorMantenimientos::ctrRangoRespaldo($rango);
// var_dump($backup);
...
foreach ($backup as $key => $value) {
    ...
    $pdf->Cell(50, 4, ''.$value['nombre_backup'].' ', 0, 0, 'C');
    $pdf->Cell(60, 4, ''.$value['fecha_creacion'].'', 0, 0, 'C');
    $pdf->Cell(60, 4, ''.$value['usuario'].'', 0, 0, 'C');
