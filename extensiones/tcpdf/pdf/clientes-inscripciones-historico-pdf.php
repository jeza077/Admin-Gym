...
$descripcionEvento = "".$_SESSION['usuario']." Generó reporte pdf de clientes inscripciones histórico";
$accion = "Generar";
$bitacoraConsulta = ControladorMantenimientos::ctrBitacoraInsertar($_SESSION['id_usuario'], 6, $accion,
$descripcionEvento);
