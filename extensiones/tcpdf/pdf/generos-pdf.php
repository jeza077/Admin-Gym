...
$descripcionEvento = "".$_SESSION['usuario']." Generó reporte pdf de géneros";
$accion = "Generar";
$bitacoraConsulta = ControladorMantenimientos::ctrBitacoraInsertar($_SESSION['id_usuario'], 35, $accion,
$descripcionEvento);
